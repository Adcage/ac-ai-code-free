...
def test_load_asset_manifest_supports_enabled_assets_and_aliases(tmp_path: Path):
    ...
    assert manifest.resolve_alias("craft", "anti-slop") == "anti-ai-slop"
    assert manifest.resolve_alias("craft", "anti-ai-slop") == "anti-ai-slop"
