...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|deleteRequests|DeleteRequest|body|true|array|DeleteRequest|
|&emsp;&emsp;id|||false|integer(int64)||
...
|&emsp;&emsp;&emsp;&emsp;inviteUser||integer||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|userEditRequest|UserEditRequest|body|true|UserEditRequest|UserEditRequest|
|&emsp;&emsp;userName|||false|string||
|&emsp;&emsp;userAvatar|||false|string||
|&emsp;&emsp;userProfile|||false|string||
|&emsp;&emsp;userRole|||false|string||
...
|&emsp;&emsp;onlyFeatured|||false|boolean||
...
**接口地址**:`/api/app/chat/gen/code/stream`
